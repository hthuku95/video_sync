    ...
    match row {
        Ok(Some((
            ...
            let response = WorkflowStatusResponse {
                ...
                node_summary,
                workflow_nodes,
                generated_artifacts: match crate::services::GeneratedArtifactService::find_for_workflow(
                    &state.db_pool,
                    id,
                )
                .await
        ...
        Err(e) => {
            ...
            (StatusCode::INTERNAL_SERVER_ERROR, "Failed to fetch workflow").into_response()
        }
    }
}
...
pub async fn get_workflow_debug(
    ...
    let workflow_row = match workflow_row {
        ...
        Err(e) => {
            ...
            return (StatusCode::INTERNAL_SERVER_ERROR, "Failed to fetch workflow").into_response();
        }
    };
    ...
    let id: uuid::Uuid = match workflow_row.try_get("id") {
        ...
        Err(e) => {
            ...
            return (StatusCode::INTERNAL_SERVER_ERROR, "Failed to decode workflow").into_response();
        }
    };
    ...
    let artifact_requirements: serde_json::Value =
        workflow_row.try_get("artifact_requirements").unwrap_or_default();
    ...
    let artifacts = crate::services::GeneratedArtifactService::find_for_workflow(&state.db_pool, id)
        .await
